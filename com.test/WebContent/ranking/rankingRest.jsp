...
<head>
<center>
<titl><h1>JDBC+JSP discussion forum Restaurant Group Ranking</h1></title>
<hr>
<br>
</center>
</head>
...
<center> <p> The ranking of the restaurant group</p> </center>
...
//connect to database
String sql = "SELECT name, points from restaurantGroup order by points desc";
...
try {
   ...
   %> <center><p> The Top 5 members in restaurant Group!! </p></center> <%
   count++;
